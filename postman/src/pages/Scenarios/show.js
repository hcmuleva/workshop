...
export const ScenarioShow = () => {
        ...
        },
        {
          ...
          render: (text, record) => (
            <span>
              ...
              <Button type="link" onClick={()=>{setStepVisible(true)}}>RunStep</Button>
            </span>
          ),
        },
      ];
 ...
 />
                    ...
                    <RunStepModal visible={stepVisible} setVisible={setStepVisible} scenarioid={record.id} variabledata={record.variables}/>  
                    <br/>
